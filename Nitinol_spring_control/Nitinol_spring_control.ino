...
#define thermistorReadMinActual 25.0 //actual minimum temperature at the thermocouple location
#define thermistorReadMaxActual 35.0 //actual maximum temperature at the thermocouple location
